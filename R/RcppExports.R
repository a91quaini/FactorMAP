...
#' @noRd
#'
FMBCpp <- function(returns, factors, include_intercept, include_standard_errors) {
    .Call(`_FactorMAP_FMBCpp`, returns, factors, include_intercept, include_standard_errors)
}
...
#' @noRd
#'
external_IterativeKRSFRPCpp <- function(returns, factors, alpha) {
    .Call(`_FactorMAP_external_IterativeKRSFRPCpp`, returns, factors, alpha)
}
